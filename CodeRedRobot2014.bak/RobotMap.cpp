...
SpeedController* RobotMap::driveParallel1 = NULL;
SpeedController* RobotMap::driveParallel2 = NULL;
...
void RobotMap::init() {
	...
	driveParallel1 = new Victor(DRV_MTR_PARA_ONE);

	driveParallel2 = new Victor(DRV_MTR_PARA_TWO);
