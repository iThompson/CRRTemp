...
//	sensors = new Sensors();
	...
	autoChooser->AddDefault("Empty Autonomous", new TemplateAuto());
	autoChooser->AddObject("Wing Autonomous", new ContainersOnStepAuto());
	autoChooser->AddObject("Motion Autonomous", new MovementAuto());
	autoChooser->AddObject("Left Move", new MoveLeftAuto());
...
void Robot::AutonomousInit() {
	autonomousCommand =  new MoveLeftAuto(); //(Command*) autoChooser->GetSelected();
