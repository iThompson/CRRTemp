...
CANJaguar* RobotMap::drivelDrive = NULL;
CANJaguar* RobotMap::driverDrive = NULL;
CANJaguar* RobotMap::drivecDrive = NULL;
...
CANJaguar* RobotMap::acquisitionlAcquisition = NULL;
CANJaguar* RobotMap::acquisitionrAcquisition = NULL;
Solenoid* RobotMap::acquisitionacqArm = NULL;
CANJaguar* RobotMap::toteStackertoteLift = NULL;
...
CANJaguar* RobotMap::containerStackercontainerLift = NULL;
...
CANJaguar* RobotMap::wingswingRetracter = NULL;
...
void RobotMap::init() {
	...
	drivelDrive = new CANJaguar(8);
	
	
	driverDrive = new CANJaguar(5);
	
	
	drivecDrive = new CANJaguar(4);
	...
	acquisitionlAcquisition = new CANJaguar(2);
	
	
	acquisitionrAcquisition = new CANJaguar(3);
	
	
	acquisitionacqArm = new Solenoid(0, 2);
	lw->AddActuator("Acquisition", "acqArm", acquisitionacqArm);
	
	toteStackertoteLift = new CANJaguar(7);
	...
	containerStackercontainerLift = new CANJaguar(6);
	...
	wingswingRetracter = new CANJaguar(9);
